...
type ShortLinkServiceClient interface {
	GetFullLink(ctx context.Context, in *ShortLinkRequest, opts ...grpc.CallOption) (*ShortLinkResponse, error)
...
func (c *shortLinkServiceClient) GetFullLink(ctx context.Context, in *ShortLinkRequest, opts ...grpc.CallOption) (*ShortLinkResponse, error) {
	out := new(ShortLinkResponse)
	err := c.cc.Invoke(ctx, "/link.ShortLinkService/GetFullLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortLinkServiceServer interface {
	GetFullLink(context.Context, *ShortLinkRequest) (*ShortLinkResponse, error)
...
func _ShortLinkService_GetFullLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShortLinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShortLinkServiceServer).GetFullLink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/link.ShortLinkService/GetFullLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortLinkServiceServer).GetFullLink(ctx, req.(*ShortLinkRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShortLinkService_GetFullLink_Handler,
		},
		{
